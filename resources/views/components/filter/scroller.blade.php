...
>
    ...
    <button
        ...
        @click="nudge(-1)"
        class="absolute left-0 z-10 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-hairline bg-white text-ink-muted shadow-card transition hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400"
    ...
    <button
        ...
        x-transition.opacity
        @click="nudge(1)"
        class="absolute right-0 z-10 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-hairline bg-white text-ink-muted shadow-card transition hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400"
