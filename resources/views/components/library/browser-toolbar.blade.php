...
<div class="space-y-4">
    ...
    <div class="flex flex-wrap gap-2">
        @foreach ($actions as $action)
            <button type="button" wire:click="{{ $action['method'] }}" class="inline-flex items-center justify-center rounded-2xl bg-[#f5f5f7] px-4 py-2.5 text-sm font-semibold tracking-tight text-zinc-800 shadow-card transition hover:bg-zinc-950 hover:text-white">
