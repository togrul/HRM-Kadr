...
@php
    ...
    $extraClasses = match ($mode) {
        ...
        'secondary', 'slate', 'step-next' => 'border-hairline bg-[#f4f4f5] text-ink-soft hover:bg-hairline active:bg-hairline',
        'gray', 'black', 'primary' => 'border-transparent bg-ink text-white hover:bg-ink-hover active:bg-ink-hover',
        'success', 'approve', 'light-green'
        ...
        'step-prev' => 'border-transparent bg-transparent text-ink-muted hover:bg-[#f4f4f5] hover:text-ink active:bg-hairline',
        default => 'border-hairline bg-white text-ink-soft hover:bg-[#fafafa] hover:text-ink active:bg-hairline-subtle',
    };
