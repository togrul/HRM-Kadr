    ...
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0 backdrop-blur-sm">
        ...
        >
           ...
           <div class="px-5 py-4 border-t border-neutral-200/70 dark:border-neutral-800/60 flex items-center justify-end gap-1">
                <button wire:click='{{ $wireClick }}' x-ref="confirmButton" type="button" class="flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium bg-rose-500 text-white hover:bg-rose-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-400 disabled:opacity-60">
