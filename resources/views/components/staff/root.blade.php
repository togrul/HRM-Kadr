...
<div @class([
    'rounded-lg px-1 py-1 flex flex-col space-y-2 shadow-sm bg-neutral-300/20',
])>
    <div class="flex items-center justify-between px-2 py-1">
        <h1 class="text-base font-medium !text-zinc-900/80 flex flex-col space-y-1 items-start">
            {!! $title !!} 
        </h1>
