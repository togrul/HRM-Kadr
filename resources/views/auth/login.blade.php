            ...
            <div class="flex flex-col w-full space-y-4 py-10 px-8 justify-center max-w-lg mx-auto h-full">
                ...
                <div class="">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- Password -->
                        <div class="mt-4">
                            <x-amazing-input id="password" :label="__('ui::auth.fields.password')" type="password"
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <label for="remember_me" class="inline-flex items-center">
                                <input id="remember_me" type="checkbox"
                                    ...
                                    name="remember">
                                <span
                                    class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('ui::auth.fields.remember_me') }}</span>
                            </label>
