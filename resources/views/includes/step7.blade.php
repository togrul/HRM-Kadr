    ...
    <x-form-card title="Kinships">
        <div class="grid grid-cols-4 gap-2">
            <div class="flex flex-col">
                <x-ui.select-dropdown label="{{ __('Kinship') }}" placeholder="---" mode="gray" class="w-full"
        ...
        <div class="grid grid-cols-2 gap-2">
            <div class="flex flex-col">
                <x-label
                    for="kinshipForm.kinship.birth_certificate_number">{{ __('Birth certificate number') }}</x-label>
            ...
            <div class="flex flex-col">
                <x-label
                    for="kinshipForm.kinship.marriage_certificate_number">{{ __('Marriage certificate number') }}</x-label>
                    ...
                    <div class="flex flex-col w-full space-y-3">
                        ...
                        @if (data_get($knshModel, 'marriage_certificate_number'))
                            <div
                                ...
                                <span
                                    class="font-medium text-neutral-500">{{ __('Marriage certificate number') }}</span>
