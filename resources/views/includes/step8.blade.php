@php
    $knowledgeStatusLabels = [
        'zəif' => __('personnel::wizard.options.knowledge_status.poor'),
        'yaxşı' => __('personnel::wizard.options.knowledge_status.good'),
        'sərbəst' => __('personnel::wizard.options.knowledge_status.fluent'),
    ];
@endphp
...
<div class="flex flex-col space-y-4">
    <div class="grid items-stretch grid-cols-1 gap-2">
        <x-form-card title="{{ __('personnel::wizard.sections.languages') }}">
            <div class="grid grid-cols-2 gap-2">
                <div class="flex flex-col">
                    <x-ui.select-dropdown
                        ...
                        :search-placeholder="data_get($stepSearchPlaceholders, 'searchLanguage', __('personnel::common.placeholders.search'))"
                    >
                    </x-ui.select-dropdown>
            ...
            <div class="flex justify-end">
                <x-button mode="black" wire:click="addLanguage">{{ __('personnel::common.actions.add') }}</x-button>
            </div>

            <div class="relative -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div class="overflow-visible">
                        <x-table.tbl :headers="[__('personnel::common.labels.language'), __('personnel::common.labels.knowledge_status'), __('personnel::common.labels.action')]">
        ...
        <x-form-card title="{{ __('personnel::wizard.sections.events') }}">
            <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3">
                <div class="flex flex-col">
                    <x-label for="miscForm.event.event_type">{{ __('personnel::common.labels.event_type') }}</x-label>
                ...
                <div class="flex flex-col">
                    <x-label for="miscForm.event.event_name">{{ __('personnel::common.labels.event_name') }}</x-label>
                ...
                <div class="flex flex-col">
                    <x-label for="miscForm.event.event_date">{{ __('personnel::common.labels.event_date') }}</x-label>
            ...
            <div class="flex items-end justify-end">
                <x-button mode="black" wire:click="addEvent">{{ __('personnel::common.actions.add') }}</x-button>
            </div>
    ...
    <div class="grid items-stretch grid-cols-1">
        <x-form-card title="{{ __('personnel::wizard.sections.scientific_degrees') }}">
            <div class="grid grid-cols-3 gap-2 md:grid-cols-9">
                <div class="flex flex-col md:col-span-2">
                    ...
                    :search-placeholder="data_get($stepSearchPlaceholders, 'searchDegree', __('personnel::common.placeholders.search'))"
                    >
                    </x-ui.select-dropdown>
                ...
                <div class="flex flex-col md:col-span-3">
                    <x-label for="miscForm.degree.science">{{ __('personnel::common.labels.science') }}</x-label>
                 ...
                 <div class="flex flex-col md:col-span-3">
                    <x-label for="miscForm.degree.subject">{{ __('personnel::common.labels.subject') }}</x-label>
                 ...
                 <div class="flex flex-col">
                    <x-label for="miscForm.degree.given_date">{{ __('personnel::common.labels.given_date') }}</x-label>
            ...
            <div class="grid items-start grid-cols-3 gap-2 md:grid-cols-9">   
                <div class="flex flex-col md:col-span-2">
                    ...
                    :search-placeholder="data_get($stepSearchPlaceholders, 'searchDegreeDocumentType', __('personnel::common.placeholders.search'))"
                    >
                    </x-ui.select-dropdown>
                ...
                <div class="flex items-start gap-2 md:col-span-3">
                    <div class="flex flex-col w-[100px] flex-none">
                        <x-label for="miscForm.degree.diplom_serie">{{ __('personnel::common.labels.diplom_serie') }}</x-label>
                    ...
                    <div class="flex flex-col w-full">
                      <x-label for="miscForm.degree.diplom_no">{{ __('personnel::common.labels.diplom') }} #</x-label>
                ...
                <div class="flex flex-col">
                    <x-label for="miscForm.degree.diplom_given_date">{{ __('personnel::common.labels.given_date') }}</x-label>
                 ...
                 <div class="flex flex-col md:col-span-3">
                    <x-label for="miscForm.degree.document_issued_by">{{ __('personnel::common.labels.document_issued_by') }}</x-label>
            ...
            <div class="flex items-end justify-end">
                <x-button mode="black" wire:click="addDegree">{{ __('personnel::common.actions.add') }}</x-button>
            </div>
        ...
        <x-form-card
            title="{{ __('personnel::wizard.sections.electorals') }}"
        ...
        >
            @if($miscForm->hasElectedElectorals)
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <div class="flex flex-col">
                        <x-label for="miscForm.election.location">{{ __('personnel::common.labels.location') }}</x-label>
                    ...
                    <div class="flex flex-col">
                        <x-label for="miscForm.election.elected_date">{{ __('personnel::common.labels.elected_date') }}</x-label>
               ...
               <div class="flex items-end justify-end">
                  <x-button mode="black" wire:click="addElection">{{ __('personnel::common.actions.add') }}</x-button>
               </div>
