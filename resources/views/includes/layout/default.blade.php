...
>
    @if ($hasSidebar)
        <aside
            ...
            id="sidebar"
            class="z-20 py-4 bg-white border-r border-dashed border-neutral-200 left-panel dark:bg-neutral-900/30 dark:border-neutral-700/60"
            role="complementary"
            aria-label="Sidebar"
        >
            {{ $sidebar }}
        ...
        >
            ...
            @if ($hasSidebar)
                <button
                    type="button"
                    @click="toggle()"
                    class="absolute flex items-center gap-1 px-2 py-1 text-sm border rounded-md shadow-sm top-1 left-1 bg-neutral-200/60 dark:bg-gray-700/60 border-neutral-200/60 dark:border-gray-600 hover:bg-neutral-200/80 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-gray-800"
