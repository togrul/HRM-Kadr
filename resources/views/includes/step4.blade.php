            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 w-full">
                <div class="flex flex-col space-y-1">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="font-medium text-slate-500 text-sm">{{ __('Date') }}</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="text-slate-900 text-sm font-medium">{{ \Carbon\Carbon::parse($laModel['join_date'])->format('d.m.Y') }}</span>
                        <span>-</span>
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <span class="text-slate-900 text-sm font-medium">x{{ $laModel['coefficient'] }}</span>
                </div>
                ...
                <div class="flex flex-col space-y-1">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="font-medium text-slate-500 text-sm">{{ __('Total') }}</span>
                    </div>
                    <span class="text-slate-900 text-sm font-medium">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 w-full">
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="font-medium text-slate-500 text-sm">{{ __('Order given by') }}</span>
                        </div>
                        <span class="text-slate-900 text-sm font-medium">{{ $laModel['order_given_by'] }}</span>
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="font-medium text-slate-500 text-sm">{{ __('Order number') }} #</span>
                        </div>
                        <span class="text-slate-900 text-sm font-medium">{{ $laModel['order_no'] }}</span>
                    </div>
                    ...
                    <div class="flex flex-col space-y-1">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="font-medium text-slate-500 text-sm">{{ __('Order date') }} #</span>
                        </div>
                        <span class="text-slate-900 text-sm font-medium">
