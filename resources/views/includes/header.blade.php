...
@php
    ...
    $preparedMenus = collect($menus)->map(static function ($menuItem) use ($moduleAliases) {
...
<header class="relative z-20">
    <div class="mx-auto max-w-7xl px-4 lg:px-0 relative">
        <aside class="module-rail-desktop absolute left-0 top-4 -translate-x-[calc(100%+7px)]" aria-label="{{ __('Module navigation') }}">
