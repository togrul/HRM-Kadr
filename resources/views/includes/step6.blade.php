...
{{--            <x-select-list-item wire:click="setData('criminal','punishment_id','criminal','---',null)" :selected="'---' == $criminalName"--}}
{{--              wire:model='criminal.punishment_id.id'>--}}
{{--              -----}}
{{--            </x-select-list-item>--}}
{{--                @foreach($criminalModel as $crm)--}}
{{--                <x-select-list-item wire:click="setData('criminal','punishment_id','criminal','{{ $crm->name }}',{{ $crm->id }})"--}}
{{--                :selected="$crm->id === $criminalId" wire:model='criminal.punishment_id.id'>--}}
{{--                    {{ $crm->name }}--}}
{{--                </x-select-list-item>--}}
{{--                @endforeach--}}
{{--        </x-select-list>--}}
{{--        @error('criminal.punishment_id.id')--}}
{{--        <x-validation> {{ $message }} </x-validation>--}}
{{--        @enderror--}}
{{--    </div>--}}
{{--    <div class="flex flex-col">--}}
