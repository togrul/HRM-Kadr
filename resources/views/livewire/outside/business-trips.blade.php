    ...
    <div class="flex flex-col space-y-4 px-6 py-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-2">
            ...
            <div class="flex flex-col xl:col-span-2">
                ...
                <x-select-list class="w-full" :title="__('Order types')" mode="gray" :selected="$selectedName" name="orderTypeId">
                    ...
                    @foreach($_order_types as $type)
                        <x-select-list-item wire:click="setData('filter','order_type_id',null,'{{ trim($type->name) }}',{{ $type->id }})"
            ...
            <div class="flex flex-col">
                ...
                <x-livewire-input mode="gray" name="filter.location" wire:model.defer="filter.location"></x-livewire-input>
            </div>
                        ...
                        @forelse ($this->businessTrips as $key => $_bTrip)
                            <tr @class([
                                ...
                                <x-table.td>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="text-sky-500">{{ \Carbon\Carbon::parse($_bTrip->start_date)->format('d.m.Y') }}</span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                ...
                                <x-table.td>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <a href="{{ route('orders',['search' => ['order_no' =>  $_bTrip->order_no ]]) }}" class="text-blue-600">{{ $_bTrip->order_no }}</a>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="text-black">{{ \Carbon\Carbon::parse($_bTrip->order_date)->format('d.m.Y') }}</span>
                                        </div>
                                    </div>
                                </x-table.td>
                                ...
                                <x-table.td :isButton="true">
                                    <button
                                        wire:click="printBusinessTripDocument('{{$_bTrip->id}}')"
