...
<div class="flex flex-col items-center justify-between sm:flex-row filter bg-white py-2 px-2 rounded-xl">
    ...
    <div class="flex items-center justify-center space-x-2 action-section">
        <x-button class="space-x-2" mode="gray" wire:click.prevent="resetFilter">
            <x-icons.refresh-icon color="text-gray-800" hover="text-gray-900"></x-icons.refresh-icon>
                ...
                @forelse ($_users as $user)
                    ...
                    <x-table.td >
                        <div class="flex items-center justify-start">
                            <x-icons.check-icon
                                size="w-8 h-8"
                                :color="$user->is_active ? 'text-green-400' : 'text-gray-300'"
                                :hover="$user->is_active ? 'text-green-500' : 'text-gray-400'"
                            ></x-icons.check-icon>
                        </div>
                     </x-table.td>
