<div class="flex flex-col space-y-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
        <div class="flex flex-col">
            ...
            <x-livewire-input mode="gray" type="number" name="staff.total" wire:model.live="staff.total"></x-livewire-input>
            @error('staff.total')
            <x-validation> {{ $message }} </x-validation>
            @enderror
        </div>
        <div class="flex flex-col">
            ...
            <x-livewire-input disabled="true" mode="gray" type="number" name="staff.filled" wire:model="staff.filled"></x-livewire-input>
            @error('staff.filled')
            <x-validation> {{ $message }} </x-validation>
            @enderror
        </div>
