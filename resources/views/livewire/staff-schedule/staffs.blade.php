        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            <div @class([
                ...
                <div class="flex items-center justify-between bg-slate-100 rounded-xl px-4 py-2">
                    <span></span>
                    <h1 class="text-lg font-medium">{{ $str }} </h1>
                    <div class="flex space-x-2 items-center">
                        <button wire:click="openSideMenu('edit-staff',{{ $stf[0]->structure_id }})" class="appearance-none w-8 h-8 flex justify-center items-center rounded-lg bg-slate-200 transition-all duration-300 hover:bg-slate-300">
                        ...
                        <button wire:click.prevent="setDeleteStaff({{ $stf[0]->structure_id  }})" class="appearance-none w-8 h-8 flex justify-center items-center rounded-lg bg-slate-200 transition-all duration-300 hover:bg-slate-300">
