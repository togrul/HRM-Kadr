    ...
    <div class="flex flex-col space-y-4 px-4 mt-4">
        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            <div @class([
                ...
                <h1 class="text-center text-lg font-medium flex justify-center bg-slate-100 rounded-xl px-4 py-2">{{ $str }} </h1>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button wire:click="openSideMenu('show-staff',{{ $st->structure_id }},{{ $st->position_id }})" class="appearance-none w-10 h-10 relative rounded-lg flex justify-center items-center bg-slate-100 text-lg">
