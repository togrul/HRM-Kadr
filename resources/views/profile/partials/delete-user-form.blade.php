<section class="space-y-6">
    ...
    >{{ __('ui::profile.titles.delete_account') }}</x-danger-button>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                <x-input-label for="password" value="{{ __('ui::auth.fields.password') }}" class="sr-only" />
                ...
                <x-text-input
                    ...
                    placeholder="{{ __('ui::auth.fields.password') }}"
                />
