...
trait OrderValidationTrait
{
    public function validationRules()
    {
        return [
            ...
            'dynamic' => [
                ...
                'components.*.rank_id' => $this->selectedBlade == Order::BLADE_DEFAULT ? 'nullable|int|exists:ranks,id' : '',
                'components.*.personnel_id' => $this->selectedBlade == Order::BLADE_DEFAULT ? 'required|int' : '',
                ...
                'components.*.structure_main_id' => $this->selectedBlade == Order::BLADE_DEFAULT ? 'required|int|exists:structures,id' : '',
                'components.*.structure_id' => $this->selectedBlade == Order::BLADE_DEFAULT ? 'required|int|exists:structures,id' : '',
                'components.*.position_id' => $this->selectedBlade == Order::BLADE_DEFAULT ? 'required|int|exists:positions,id' : '',
    ...
    protected function validationAttributes()
    {
        return [
            ...
            'components.*.structure_main_id' => __('Main structure'),
            'components.*.structure_id' => __('Structure'),
            'components.*.position_id' => __('Position'),
