    ...
    public function validationRules()
    {
        return [
            ...
            'dynamic' => [
                ...
                'components.*.meeting_hour' => $this->selectedBlade == Order::BLADE_BUSINESS_TRIP ? 'required|string' : '',
                'components.*.return_month' => $this->selectedBlade == Order::BLADE_BUSINESS_TRIP ? 'required|string' : '',
                'components.*.return_day' => $this->selectedBlade == Order::BLADE_BUSINESS_TRIP ? 'required|int|min:1|max:31' : '',
            ],
        ];
    }
