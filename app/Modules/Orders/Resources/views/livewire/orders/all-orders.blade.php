...
>
    ...
    <div class="flex flex-col px-6 py-4 space-y-4">
        <div class="flex items-center justify-between gap-4 rounded-2xl border border-teal-200 bg-teal-50/80 px-5 py-4 shadow-sm">
            <div class="min-w-0">
                <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                    <p class="shrink-0 text-[11px] font-semibold uppercase tracking-[0.22em] text-teal-700">{{ __('orders::order_list.guide.title') }}</p>
                    <p class="text-sm leading-6 text-teal-900/80">{{ __('orders::order_list.guide.description') }}</p>
                </div>
            </div>
            <a
