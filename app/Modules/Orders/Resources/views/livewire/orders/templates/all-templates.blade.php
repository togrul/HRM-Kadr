...
>
    ...
    <div class="flex flex-col space-y-2">
        <div class="grid grid-cols-1 gap-2 mt-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @forelse ($templates as $template)
                <div class="flex flex-col w-full px-3 py-4 space-y-2 border rounded-lg shadow-sm bg-neutral-50 border-neutral-100">
                    <div class="flex flex-col items-center justify-center space-y-2">
                        <h1 class="flex items-center justify-center px-3 py-1 text-sm font-medium text-center text-blue-500 bg-blue-100 rounded-xl">
                    ...
                    <div class="flex items-center justify-between py-2 border-t border-dashed border-slate-300">
                        @if($status != 'deleted')
                        {{--@can('manage-templates')--}}
                            <a href="javascript:void(0)" wire:click.prevent="openSideMenu('edit-template',{{ $template->id }})" class="flex items-center justify-center w-8 h-8 text-xs font-medium text-gray-500 uppercase rounded-lg hover:bg-gray-200 hover:text-gray-700">
                            ...
                            <button
                                ...
                                class="flex items-center justify-center w-8 h-8 text-xs font-medium text-gray-500 uppercase transition duration-300 rounded-lg hover:bg-emerald-100 hover:text-gray-700"
                            >
            ...
            @empty
                <div class="flex flex-col items-center justify-center py-8 space-y-2 sm:col-span-2 md:col-span-3 lg:col-span-4 bg-slate-50">
