...
<x-surface-card :title="__('notifications::common.titles.approval_queue')" icon="icons.pending-icon">
    <div class="space-y-3">
        @forelse ($campaigns as $campaign)
            <div class="rounded-2xl border border-zinc-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.92))] px-4 py-4 shadow-card sm:px-5">
                <div class="space-y-4">
                    <div class="space-y-3">
        ...
        @empty
            <div class="rounded-2xl border border-dashed border-zinc-200 bg-[linear-gradient(180deg,rgba(250,250,250,0.85),rgba(244,244,245,0.75))] px-5 py-10 text-center">
