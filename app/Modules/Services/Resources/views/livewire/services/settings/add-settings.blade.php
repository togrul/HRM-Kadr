        ...
        <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
            ...
            <form wire:submit.prevent='store' action="#" method="POST" class="px-4 py-6 space-y-4">
                ...
                <div class="grid grid-cols-1 gap-2 sm:grid-cols-3">
                    <div>
                        <x-label for="settings.name">{{ __('services::common.labels.name') }}</x-label>
                    ...
                    <div>
                        <x-label for="settings.value">{{ __('services::common.labels.value') }}</x-label>
                    ...
                    <div>
                        <x-label for="settings.type">{{ __('services::common.labels.type') }}</x-label>
