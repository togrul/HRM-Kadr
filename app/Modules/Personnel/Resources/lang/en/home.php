...
return [
    ...
    'subjects' => [
        'attendance_manual_entry' => 'attendance entry',
        'attendance_overtime_request' => 'overtime request',
        'candidate' => 'candidate',
        'employee_compensation' => 'pay assignment',
        'order_log' => 'order',
        'payroll_period' => 'payroll period',
        'payroll_run' => 'payroll run',
        'performance_bonus_rule' => 'bonus rule',
        'performance_calibration_adjustment' => 'calibration adjustment',
        'performance_cycle' => 'review cycle',
        'performance_feedback_request' => 'feedback request',
        'performance_form' => 'review form',
        'performance_form_template' => 'form template',
        'performance_form_template_item' => 'form template',
        'performance_form_template_section' => 'form template',
        'performance_goal' => 'goal',
        'performance_kpi' => 'KPI',
        'performance_kpi_template' => 'KPI template',
        'performance_kpi_template_item' => 'KPI template',
        'performance_scorecard' => 'KPI scorecard',
        'performance_scorecard_checkin' => 'KPI scorecard',
        'performance_scorecard_item' => 'KPI scorecard',
        'personnel' => 'employee record',
        'personnel_card' => 'service card',
        'personnel_education' => 'education record',
        'personnel_identity_document' => 'ID card',
        'personnel_injury' => 'injury record',
        'personnel_labor_activity' => 'work history',
        'personnel_military_service' => 'military service',
        'personnel_passports' => 'passport',
        'personnel_rank' => 'rank',
        'staff_schedule' => 'staff position',
        'training_annual_plan' => 'annual training plan',
        'training_session' => 'training session',
        'leave' => 'leave',
        'personnel_vacation' => 'vacation',
        'personnel_business_trip' => 'business trip',
        'other' => 'record',
    ],
];
