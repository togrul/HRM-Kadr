...
class PersonnelListRenderBenchmarkCommand extends Command
{
    ...
    public function handle(LivewireComponentProfiler $profiler): int
    {
        ...
        $results[] = $this->probe('all_personnel_filter_open', $budgets['all_personnel_filter_open'], fn () => $profiler->measureInteraction($user, AllPersonnel::class, fn ($component) => $component->call('openFilter')->call('handleFilterDetailReady')));
