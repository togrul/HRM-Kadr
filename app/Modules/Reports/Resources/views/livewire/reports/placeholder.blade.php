<div class="space-y-5 animate-pulse px-4 py-3 lg:px-5">
    <div class="overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-card">
        ...
        <div class="grid gap-5 p-5 lg:grid-cols-[1.1fr,0.9fr]">
            <div class="rounded-2xl border border-zinc-200/90 bg-zinc-50/70 p-5 shadow-card">
                ...
                <div class="mt-8 h-[220px] rounded-2xl border border-zinc-100 bg-white px-5 py-4 shadow-card">
            ...
            <div class="grid gap-px overflow-hidden rounded-2xl border border-zinc-200/90 bg-zinc-200/70 sm:grid-cols-2">
    ...
    <div class="grid gap-5 lg:grid-cols-3">
        <div class="overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-card">
            ...
            <div class="space-y-4 p-5">
                @foreach ([82, 38] as $bar)
                    <div class="rounded-2xl border border-zinc-200/90 bg-zinc-50/70 p-4 shadow-card">
        ...
        <div class="lg:col-span-2 overflow-hidden rounded-2xl border border-zinc-200/90 bg-white shadow-card">
            <div class="border-b border-zinc-200 px-5 py-4 lg:px-6">
                <div class="h-3 w-36 rounded-full bg-zinc-100"></div>
                <div class="mt-3 h-7 w-56 rounded-full bg-zinc-100"></div>
            </div>
            <div class="grid gap-3 p-5 sm:grid-cols-2 md:grid-cols-3">
                @foreach (range(1, 6) as $tile)
                    <div class="rounded-2xl border border-zinc-200/90 bg-white p-5 shadow-card">
