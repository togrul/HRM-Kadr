...
<div class="rounded-2xl border border-zinc-200 bg-white p-3 shadow-card">
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div class="space-y-1">
            ...
            <p class="max-w-3xl text-sm leading-6 text-zinc-500">
        ...
        <nav class="flex flex-wrap items-center gap-2">
            @foreach ($tabs as $tab)
                ...
                <a
                    ...
                    class="{{ $active ? 'border-zinc-900 bg-zinc-900 text-white shadow-card' : 'border-zinc-200 bg-zinc-50 text-zinc-600 hover:border-zinc-300 hover:bg-white hover:text-zinc-900' }} inline-flex items-center rounded-full border px-4 py-2 text-sm font-semibold transition"
                >
                    {{ $tab['label'] }}
                </a>
            @endforeach
