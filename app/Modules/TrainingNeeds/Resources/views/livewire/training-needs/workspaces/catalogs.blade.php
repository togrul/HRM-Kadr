        ...
        <x-surface-card :title="__('training_needs::dashboard.cards.competency_groups')" icon="icons.folder-plus-icon" bodyClass="overflow-visible" contentClass="overflow-visible p-4">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <x-livewire-input mode="gray" id="group-name" wire:model="groupForm.name" />
                ...
                <div>
                    ...
                    <x-livewire-input mode="gray" id="group-sort-order" type="number" wire:model="groupForm.sort_order" />
        ...
        <x-surface-card :title="__('training_needs::dashboard.cards.competency_levels')" icon="icons.profile-outline-icon" bodyClass="overflow-visible" contentClass="overflow-visible p-4">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <div>
                    ...
                    <x-livewire-input mode="gray" id="level-name" wire:model="levelForm.name" />
                ...
                <div>
                    ...
                    <x-livewire-input mode="gray" id="level-score" type="number" wire:model="levelForm.score" />
                ...
                <div>
                    ...
                    <x-livewire-input mode="gray" id="level-sort-order" type="number" wire:model="levelForm.sort_order" />
        ...
        <x-surface-card :title="__('training_needs::dashboard.cards.competencies')" icon="icons.profile-icon" bodyClass="overflow-visible" contentClass="overflow-visible p-4">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <x-livewire-input mode="gray" id="competency-name" wire:model="competencyForm.name" />
        ...
        <x-surface-card :title="__('training_needs::dashboard.cards.programs')" icon="icons.clock-icon" bodyClass="overflow-visible" contentClass="overflow-visible p-4">
            ...
            <div class="grid gap-3 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <x-livewire-input mode="gray" id="program-title" wire:model="programForm.title" />
                ...
                <div>
                    ...
                    <x-livewire-input mode="gray" id="program-code" wire:model="programForm.code" />
                ...
                <div>
                    ...
                    <x-livewire-input mode="gray" id="program-hours" type="number" step="0.25" wire:model="programForm.duration_hours" />
