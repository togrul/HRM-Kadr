...
class KpiDailyCommand extends Command
{
    ...
    protected $description = 'Close KPI cards of people who left or moved, auto-accept overdue agreements, send deadline reminders and escalations, refill KPIs from HRM data';
