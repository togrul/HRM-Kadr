                            ...
                            <div class="flex items-center justify-between gap-2">
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <x-ui.action-pill mode="delete" wire:click="deleteCycle({{ $cycle->id }})" wire:confirm="{{ __('performance_evaluation::dashboard.confirmations.delete_cycle') }}" icon="icons.delete-icon">{{ __('performance_evaluation::dashboard.actions.delete') }}</x-ui.action-pill>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start justify-between gap-2">
                                ...
                                <div class="flex flex-col items-end gap-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <x-ui.action-pill mode="delete" wire:click="deleteTemplate({{ $template->id }})" wire:confirm="{{ __('performance_evaluation::dashboard.confirmations.delete_template') }}" icon="icons.delete-icon">{{ __('performance_evaluation::dashboard.actions.delete') }}</x-ui.action-pill>
                                    </div>
                                </div>
                            </div>
                            @if (filled($template->description))
                        ...
                        <x-ui.list-card>
                            <div class="flex items-center justify-between gap-2">
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500">{{ $section->template?->name ?? '—' }}</p>
                                </div>
                                <div class="flex flex-col items-end gap-2">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <x-ui.action-pill mode="delete" wire:click="deleteSection({{ $section->id }})" wire:confirm="{{ __('performance_evaluation::dashboard.confirmations.delete_section') }}" icon="icons.delete-icon">{{ __('performance_evaluation::dashboard.actions.delete') }}</x-ui.action-pill>
                                    </div>
                                </div>
                            </div>
                        </x-ui.list-card>
                        ...
                        <x-ui.list-card>
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-wrap gap-2 border-t border-zinc-200/80 pt-3">
                                    ...
                                    <x-ui.action-pill class="self-start" mode="delete" wire:click="deleteItem({{ $item->id }})" wire:confirm="{{ __('performance_evaluation::dashboard.confirmations.delete_item') }}" icon="icons.delete-icon">{{ __('performance_evaluation::dashboard.actions.delete') }}</x-ui.action-pill>
                                </div>
                            </div>
                        </x-ui.list-card>
                    @empty
                    ...
                    @forelse ($this->recentForms as $form)
                        <x-ui.list-card>
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-wrap gap-2 border-t border-zinc-200/80 pt-3">
                                    <x-ui.action-pill class="self-start" wire:click="editEvaluationForm({{ $form->id }})" icon="icons.edit-icon">{{ __('performance_evaluation::dashboard.actions.edit') }}</x-ui.action-pill>
                                    <x-ui.action-pill class="self-start" mode="delete" wire:click="deleteEvaluationForm({{ $form->id }})" wire:confirm="{{ __('performance_evaluation::dashboard.confirmations.delete_form') }}" icon="icons.delete-icon">{{ __('performance_evaluation::dashboard.actions.delete') }}</x-ui.action-pill>
                                </div>
                            </div>
                        </x-ui.list-card>
                    @empty
