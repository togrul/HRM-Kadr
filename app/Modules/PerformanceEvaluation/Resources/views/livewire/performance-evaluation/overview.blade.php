        ...
        <section class="overflow-hidden rounded-2xl border border-hairline bg-white shadow-card">
            ...
            <div class="p-4">
                <div class="flex flex-wrap gap-2">
                    <button type="button" wire:click="exportPerformanceFormsReport" wire:loading.attr="disabled" wire:target="exportPerformanceFormsReport" class="inline-flex h-9 items-center gap-2 rounded-xl border border-hairline bg-white px-3 text-[12.5px] font-medium text-ink-soft transition hover:border-zinc-300 hover:text-ink"><svg class="h-4 w-4 text-ink-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M12 11v6M9 14l3 3 3-3"/></svg>{{ __('performance_evaluation::dashboard.actions.export_forms_report') }}</button>
                    <button type="button" wire:click="exportPerformanceSummaryReport" wire:loading.attr="disabled" wire:target="exportPerformanceSummaryReport" class="inline-flex h-9 items-center gap-2 rounded-xl border border-hairline bg-white px-3 text-[12.5px] font-medium text-ink-soft transition hover:border-zinc-300 hover:text-ink"><svg class="h-4 w-4 text-ink-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M12 11v6M9 14l3 3 3-3"/></svg>{{ __('performance_evaluation::dashboard.actions.export_summary_report') }}</button>
                    <button type="button" wire:click="exportPerformanceWeakLinksReport" wire:loading.attr="disabled" wire:target="exportPerformanceWeakLinksReport" class="inline-flex h-9 items-center gap-2 rounded-xl border border-hairline bg-white px-3 text-[12.5px] font-medium text-ink-soft transition hover:border-zinc-300 hover:text-ink"><svg class="h-4 w-4 text-ink-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M12 11v6M9 14l3 3 3-3"/></svg>{{ __('performance_evaluation::dashboard.actions.export_weak_links_report') }}</button>
                    <button type="button" wire:click="exportPerformanceWeakPivotReport" wire:loading.attr="disabled" wire:target="exportPerformanceWeakPivotReport" class="inline-flex h-9 items-center gap-2 rounded-xl border border-hairline bg-white px-3 text-[12.5px] font-medium text-ink-soft transition hover:border-zinc-300 hover:text-ink"><svg class="h-4 w-4 text-ink-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M12 11v6M9 14l3 3 3-3"/></svg>{{ __('performance_evaluation::dashboard.actions.export_weak_pivot_report') }}</button>
                    <button type="button" wire:click="exportPerformanceAuditReport" wire:loading.attr="disabled" wire:target="exportPerformanceAuditReport" class="inline-flex h-9 items-center gap-2 rounded-xl border border-hairline bg-white px-3 text-[12.5px] font-medium text-ink-soft transition hover:border-zinc-300 hover:text-ink"><svg class="h-4 w-4 text-ink-faint" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M12 11v6M9 14l3 3 3-3"/></svg>{{ __('performance_evaluation::dashboard.actions.export_audit_report') }}</button>
                </div>
