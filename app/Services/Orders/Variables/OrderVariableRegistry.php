...
class OrderVariableRegistry
{
    ...
    private function employeeVariables(): array
    {
        return [
            ...
            $this->def('employee.full_name_instrumental', 'Tam ad – ilə', 'İşçi', 'Bayramov Ruslan Bəxtiyar oğlu ilə'),
            ...
            $this->def('employee.initials_instrumental', 'İnisiallar – ilə (...la)', 'İşçi', 'R.B.Bayramovla'),
