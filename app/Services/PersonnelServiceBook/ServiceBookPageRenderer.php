...
namespace App\Services\PersonnelServiceBook;

use App\Models\Personnel;
use App\Models\PersonnelBusinessTrip;
use App\Services\BaseWordExportService;
...
class ServiceBookPageRenderer extends BaseWordExportService
{
    public function renderPage1(Section $section, Personnel $personnel): void
    {
    ...
    public function renderPage2(Section $section, Personnel $personnel): void
    {
    ...
    public function renderPage3(Section $section, Personnel $personnel): void
    {
    ...
    public function renderPage4(Section $section, Personnel $personnel): void
    {
    ...
    public function renderPage5(Section $section, Personnel $personnel): void
    {
    ...
    public function renderPage14(Section $section, Personnel $personnel): void
    {
        $col1 = $this->cm(6.0);
        $col2 = $this->cm(6.0);
        $col3 = $this->cm(6.0);
    ...
    public function renderPage15(Section $section, Personnel $personnel): void
    {
        $docWidth = $this->cm(18.0);
        $col1 = $this->cm(8.0);
        $col2 = $this->cm(3.4);
    ...
    public function renderPage16(Section $section, Personnel $personnel): void
    {
        $docWidth = $this->cm(18.0);
    ...
    private function addPersonnelSignatureBlock(Section $section, string $label, bool $includePosition = true): void
    {
    ...
    private function addDateSignatureLine(CellElement $container): void
    {
    ...
    private function addUnderlinedLine(Section $section, string $text, string $label, int $width): void
    {
    ...
    private function addSignatureLine(CellElement $container, int $width): void
    {
    ...
    private function addMergedLabelRow(Table $table, string $label, string $value, int $labelWidth, int $valueWidth, int $heightTwip, int $labelSize = 10): void
    {
    ...
    private function addEducationList(CellElement $cell, Personnel $personnel, bool $isMilitary): void
    {
        $entries = [];
