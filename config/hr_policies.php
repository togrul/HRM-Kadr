...
$performanceTabs = ['overview', 'kpi_scorecards', 'kpi_analytics', 'kpi_bonus', 'kpi_library', 'goals', 'succession', 'feedback', 'cycles', 'templates', 'evaluations', 'tests', 'reports', 'lists'];
