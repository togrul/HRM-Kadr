...
class ImportCandidateToPersonnelTest extends TestCase
{
    ...
    public function test_it_throws_friendly_message_when_matching_active_personnel_already_exists(): void
    {
        app()->setLocale('az');
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('Məhərrəmli Rəşid Rəşad üçün artıq aktiv personal mövcuddur. Tabel nömrəsi: DMX-26-000002.');
