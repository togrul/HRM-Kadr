...
class NotificationsQueryBudgetCommandTest extends TestCase
{
    use RefreshDatabase;

    public function test_it_reports_query_budget_metrics_for_notification_settings_islands(): void
    {
        User::factory()->create(['is_active' => true]);

        $exitCode = Artisan::call('notifications:query-budget', ['--json' => true]);
