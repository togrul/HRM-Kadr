...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-dropdown','data' => ['label' => __('Parent'),'placeholder' => '---','mode' => 'default','class' => 'w-full','wire:model.live' => 'form.parent_id','model' => $this->parentStructureOptions()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Parent')),'placeholder' => '---','mode' => 'default','class' => 'w-full','wire:model.live' => 'form.parent_id','model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->parentStructureOptions())]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.livewire-input','data' => ['mode' => 'gray','name' => 'searchParent','wire:model.live.debounce.300ms' => 'searchParent','placeholder' => ''.e(__('Search...')).'','@click.stop' => 'isOpen = true','xOn:input.stop' => 'null','xOn:keyup.stop' => 'null','xOn:keydown.stop' => 'null','xOn:change.stop' => 'null']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['mode' => 'gray','name' => 'searchParent','wire:model.live.debounce.300ms' => 'searchParent','placeholder' => ''.e(__('Search...')).'','@click.stop' => 'isOpen = true','x-on:input.stop' => 'null','x-on:keyup.stop' => 'null','x-on:keydown.stop' => 'null','x-on:change.stop' => 'null']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.parent_id'];
