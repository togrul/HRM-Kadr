...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span
                                                class="text-sky-500"><?php echo e(\Carbon\Carbon::parse($_bTrip->start_date)->format('d.m.Y')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="text-gray-500"><?php echo e(__('End date')); ?>:</span>
                                            <span
                                                class="text-rose-500"><?php echo e(\Carbon\Carbon::parse($_bTrip->end_date)->format('d.m.Y')); ?></span>
                                        </div>
                                        <!--[if BLOCK]><![endif]--><?php if(\Illuminate\Support\Arr::get($search, 'business_trip_status', '') == 'deleted'): ?>
                                            <div class="flex flex-col text-sm font-medium">
                                                <div class="flex items-center space-x-1">
                                                    ...
                                                    <span
                                                        class="text-black"><?php echo e(\Carbon\Carbon::parse($_bTrip->deleted_at)->format('d.m.Y H:i')); ?></span>
                                                </div>
                                                <div class="flex items-center space-x-1">
                                                    <span class="text-gray-500"><?php echo e(__('Deleted by')); ?>:</span>
                                                    <span
                                                        class="text-black"><?php echo e($_bTrip->personDidDelete->name); ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <a href="<?php echo e(route('orders', ['search' => ['order_no' => $_bTrip->order_no]])); ?>"
                                                class="text-blue-600"><?php echo e($_bTrip->order_no); ?></a>
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span
                                                class="text-black"><?php echo e(\Carbon\Carbon::parse($_bTrip->order_date)->format('d.m.Y')); ?></span>
                                        </div>
                                    </div>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/outside/business-trips.blade.php ENDPATH**/ ?>