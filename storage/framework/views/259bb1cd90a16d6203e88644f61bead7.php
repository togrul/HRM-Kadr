      ...
      >
        ...
        <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto bg-rose-50 rounded-full sm:mx-0 sm:h-10 sm:w-10">
                <!-- Heroicon name: outline/exclamation -->
                  <?php echo $__env->make('components.icons.info-icon', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>
          ...
          <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
            <button wire:click='<?php echo e($wireClick); ?>' x-ref="confirmButton" type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-normal text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/components/modal-delete.blade.php ENDPATH**/ ?>