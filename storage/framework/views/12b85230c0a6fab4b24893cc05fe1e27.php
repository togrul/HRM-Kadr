...
>
    ...
    <!--[if BLOCK]><![endif]--><?php if($selectedVacation): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list','data' => ['class' => 'w-full','title' => '','mode' => 'gray','selected' => $selectedName,'name' => 'reservedMonth']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full','title' => '','mode' => 'gray','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedName),'name' => 'reservedMonth']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list-item','data' => ['wire:click' => 'setData(\'month\',\'reserved_date_month\',null,\'---\',null)','selected' => '---' ==  $selectedName,'wire:model' => 'month.reserved_date_month.id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'setData(\'month\',\'reserved_date_month\',null,\'---\',null)','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('---' ==  $selectedName),'wire:model' => 'month.reserved_date_month.id']); ?>
                    ---
...
<?php endif; ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mValue => $mKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginalfad9b9ef9db98dab13eefb5c81eb8bee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfad9b9ef9db98dab13eefb5c81eb8bee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list-item','data' => ['wire:click' => 'setData(\'month\',\'reserved_date_month\',null,\''.e($mValue).'\','.e($mKey).')','selected' => $mKey === $selectedId,'wire:model' => 'month.reserved_date_month.id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('select-list-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'setData(\'month\',\'reserved_date_month\',null,\''.e($mValue).'\','.e($mKey).')','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mKey === $selectedId),'wire:model' => 'month.reserved_date_month.id']); ?>
                        <?php echo e($mValue); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.tbl','data' => ['headers' => [__('Year'),__('Reserved month'),__('Total days'),__('Remaining days'), __('Used') ,'action']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('Year'),__('Reserved month'),__('Total days'),__('Remaining days'), __('Used') ,'action'])]); ?>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $personnelModelData->yearlyVacation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
...
<?php $component->withAttributes([]); ?>
                                <span class="text-sm bg-slate-100 rounded-md shadow-sm px-3 py-1 font-medium flex justify-center items-center text-slate-600"><?php echo e($vacation->year); ?></span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center justify-center space-x-2">
                                     <span class="text-sm font-medium flex items-center text-slate-900">
                                         <?php echo e(array_search($vacation->reserved_date_month, $months)); ?>

                                    </span>
                                    <button wire:click="updateMonth(<?php echo e($vacation); ?>)">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.edit-icon','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <span class="text-sm font-medium flex items-center text-slate-900"><?php echo e($vacation->vacation_days_total); ?></span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <span class="text-sm font-medium flex items-center text-green-500"><?php echo e($vacation->remaining_days); ?></span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <span class="text-sm font-medium flex items-center text-rose-500"><?php echo e($vacation->used_days); ?></span>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                <div class="flex items-center space-x-2">
                                    <button wire:click="goToVacations('<?php echo e($vacation->year); ?>')"
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/personnel/vacation-list.blade.php ENDPATH**/ ?>