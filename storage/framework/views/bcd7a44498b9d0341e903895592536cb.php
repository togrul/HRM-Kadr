     ...
     x-init="
        ...
        Livewire.hook('message.processed', (message,component) => {
            ...
            if(
                ...
                || ['documentTypesUpdated'].includes(message.updateQueue[0].payload.event)
...
<?php endif; ?>
                <span><?php echo e(__('Add document type')); ?></span>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('ID'),__('Name'),'action'])]); ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $documentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/admin/document-types.blade.php ENDPATH**/ ?>