     ...
     x-init="
        ...
        Livewire.hook('message.processed', (message,component) => {
            ...
            if(
                ...
                || ['orderCategoryUpdated'].includes(message.updateQueue[0].payload.event)
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('ID'),__('Name'),'action'])]); ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $orderCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col space-y-1">
                                        <span class="text-sm font-medium">
                                            <b>AZ</b> - <?php echo e($category->name_az); ?>

                                        </span>
                                        <span class="text-sm font-medium">
                                            <b>EN</b> - <?php echo e($category->name_en); ?>

                                        </span>
                                        <span class="text-sm font-medium">
                                            <b>RU</b> - <?php echo e($category->name_ru); ?>
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/admin/order-categories.blade.php ENDPATH**/ ?>