<div class="flex flex-col space-y-2">
    <!--[if BLOCK]><![endif]--><?php if(!empty($selectedComponents[$i])): ?>
        <div class="grid w-full grid-cols-1 gap-2 mt-3 sm:grid-cols-3 sm:col-span-2">
