...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.refresh-icon','data' => ['color' => 'text-gray-400','hover' => 'text-gray-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'text-gray-400','hover' => 'text-gray-200']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                    <!--[if BLOCK]><![endif]--><?php if($status == 2): ?>
                                        <div class="flex flex-col text-xs font-medium">
                                            <div class="flex items-center space-x-1">
                                                ...
                                                <span
                                                    class="text-black"><?php echo e(\Carbon\Carbon::parse($user->deleted_at)->format('d-m-Y H:i')); ?></span>
                                            </div>
                                            <div class="flex items-center space-x-1">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a href="#"
                                            wire:click.prevent="openSideMenu('edit-user',<?php echo e($user); ?>)"
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                    <!--[if BLOCK]><![endif]--><?php if($status == 2): ?>
                                        <button wire:click="restoreData(<?php echo e($user->id); ?>)"
...
<?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <button wire:click.prevent = "setDeleteUser(<?php echo e($user->id); ?>)"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-808792676-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-808792676-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-808792676-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/services/users/all-users.blade.php ENDPATH**/ ?>