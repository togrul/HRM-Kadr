...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list','data' => ['class' => 'w-full','title' => __('Structure'),'mode' => 'gray','selected' => $structureData[0]['structure']['name'],'name' => 'structureId']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Structure')),'mode' => 'gray','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($structureData[0]['structure']['name']),'name' => 'structureId']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list-item','data' => ['wire:click' => 'setData(0,\'structureData\',\'structure_id\',\'structure\',\'---\',null)','selected' => -1 == $structureData[0]['structure_id'],'wire:model' => 'staff.structure_id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'setData(0,\'structureData\',\'structure_id\',\'structure\',\'---\',null)','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(-1 == $structureData[0]['structure_id']),'wire:model' => 'staff.structure_id']); ?>
                  ---
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalfad9b9ef9db98dab13eefb5c81eb8bee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfad9b9ef9db98dab13eefb5c81eb8bee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.select-list-item','data' => ['wire:click' => 'setData(0,\'structureData\',\'structure_id\',\'structure\',\''.e($structure->name).'\','.e($structure->id).')','selected' => $structure->id === $structureData[0]['structure_id'],'wire:model' => 'staff.structure_id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('select-list-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'setData(0,\'structureData\',\'structure_id\',\'structure\',\''.e($structure->name).'\','.e($structure->id).')','selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($structure->id === $structureData[0]['structure_id']),'wire:model' => 'staff.structure_id']); ?>
...
<?php endif; ?>
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['structureData.*.structure_id'];
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/staff-schedule/add-staff.blade.php ENDPATH**/ ?>