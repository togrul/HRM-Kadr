                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if(!empty($_candidate->deleted_at)): ?>
                                            <div class="flex flex-col text-xs font-medium">
                                                <div class="flex items-center space-x-1">
                                                    ...
                                                    <span
                                                        class="text-black"><?php echo e(\Carbon\Carbon::parse($_candidate->deleted_at)->format('d-m-Y H:i')); ?></span>
                                                </div>
                                                <div class="flex items-center space-x-1">
                                                    <span class="text-gray-500"><?php echo e(__('Deleted by')); ?>:</span>
                                                    <span
                                                        class="text-black"><?php echo e($_candidate->personDidDelete->name); ?></span>
                                                </div>
                                            </div>
...
<?php $component->withAttributes([]); ?>
                                    <span
                                        class="text-gray-900 text-sm font-medium bg-slate-100 px-2 py-2 rounded-lg"><?php echo e($_candidate->structure->name); ?></span>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b)): ?>
<?php $attributes = $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b; ?>
...
<?php $component->withAttributes([]); ?>
                                    ...
                                    <div class="flex flex-col space-y-1">
                                        <div class="flex space-x-1 items-center">
                                            <span
                                                class="text-gray-500 text-sm font-medium"><?php echo e(__('Knowledge')); ?>:</span>
                                            <span
                                                class="text-sm font-medium px-2 py-1 rounded-lg bg-<?php echo e($_status_color[$_candidate->knowledge_test]); ?>-100 text-<?php echo e($_status_color[$_candidate->knowledge_test]); ?>-500"><?php echo e($_candidate->knowledge_test); ?></span>
                                        </div>
                                        <div class="flex space-x-1 items-center">
                                            <span
                                                class="text-gray-500 text-sm font-medium"><?php echo e(__('Physical fitness')); ?>:</span>
                                            <span
                                                class="text-sm font-medium px-2 py-1 rounded-lg bg-<?php echo e($_status_color[$_candidate->physical_fitness_exam]); ?>-100 text-<?php echo e($_status_color[$_candidate->physical_fitness_exam]); ?>-500"><?php echo e($_candidate->physical_fitness_exam); ?></span>
                                        </div>
                                    </div>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.cell-vertical','data' => ['title' => 'Appeal date']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Appeal date']); ?>
                                            <?php echo e(\Carbon\Carbon::parse($_candidate->appeal_date)->format('d.m.Y')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.status','data' => ['statusId' => $_candidate->status_id,'label' => $_candidate->status->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($_candidate->status_id),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($_candidate->status->name)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                    <!--[if BLOCK]><![endif]--><?php if($status != 'deleted'): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-candidates')): ?>
                                            <a href="#"
                                                wire:click="openSideMenu('edit-candidate',<?php echo e($_candidate->id); ?>)"
                                    ...
                                    <?php else: ?>
                                        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Admin')): ?>
                                            <button wire:click="restoreData('<?php echo e($_candidate->id); ?>')"
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                    <!--[if BLOCK]><![endif]--><?php if($status != 'deleted'): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-candidates')): ?>
                                            <button wire:click="setDeleteCandidate('<?php echo e($_candidate->id); ?>')"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1276749052-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1276749052-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1276749052-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/candidates/candidate-list.blade.php ENDPATH**/ ?>