...
$__html = app('livewire')->mount($__name, $__params, 'vaRGkbt', $__slots ?? [], get_defined_vars());
...
?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 px-6 py-4">
        ...
        <div class="flex justify-end items-center space-x-2">
            ...
            <button class="flex items-center justify-center transition-all duration-300 rounded-xl bg-rose-50 text-rose-500 hover:bg-rose-100 space-x-2 p-2" type="button">                    
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-rose-400 transition-all duration-300 hover:text-red-500">
    ...
    <div class="flex flex-col space-y-4 px-4 mt-4">
        ...
        <div class="grid grid-cols-1 gap-3">
            <?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $str => $stf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $total_sum = 0;
                $total_filled = 0;
                $total_vacant = 0;
            ...
            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                ...
                <div class="flex items-center justify-between bg-slate-100 rounded-xl px-4 py-2">
                    <span></span>
                    <h1 class="text-lg font-medium"><?php echo e($str); ?> </h1>
                    <div class="flex space-x-2 items-center">
                        <button wire:click="openSideMenu('edit-staff',<?php echo e($stf[0]->structure_id); ?>)" class="appearance-none w-8 h-8 flex justify-center items-center rounded-lg bg-slate-200 transition-all duration-300 hover:bg-slate-300">
                        ...
                        <button wire:click.prevent="setDeleteStaff(<?php echo e($stf[0]->structure_id); ?>)" class="appearance-none w-8 h-8 flex justify-center items-center rounded-lg bg-slate-200 transition-all duration-300 hover:bg-slate-300">
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                      ...
                      <div class="md:col-span-2">  
                        ...
                        <table class="w-full">
                            <thead>
                                <tr>
                                    <?php if(!empty($stf[0]->structure->parent_id)): ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $stf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $total_sum += $st->total;
...
$__html = app('livewire')->mount($__name, $__params, 'x7uBaGj', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <?php if($showSideMenu == 'edit-staff'): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'kyOclcp', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <?php if($showSideMenu == 'show-staff'): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'C1V8RUx', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, '2lYQOfM', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/staff-schedule/staffs.blade.php ENDPATH**/ ?>