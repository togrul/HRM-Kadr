...
<?php $component->withAttributes([]); ?>
                                <div class="flex space-x-2 items-center">
                                    <div class="flex justify-center items-center p-2 rounded-xl bg-<?php echo e($menu->color); ?>-100">
                                        <?php echo $menu->icon; ?>
...
<?php $component->withAttributes(['isButton' => true]); ?>
                              ...
                              <a href="#" wire:click.prevent="openSideMenu('edit-menu',<?php echo e($menu); ?>)" class="flex items-center justify-center w-8 h-8 text-xs font-medium uppercase rounded-lg text-gray-500 bg-gray-100 hover:bg-gray-200 hover:text-gray-700">
...
<?php $component->withAttributes(['isButton' => true]); ?>
                            ...
                            <button
                                wire:click.prevent = "setDeleteMenu(<?php echo e($menu->id); ?>)"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2326273969-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2326273969-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2326273969-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/services/menus/all-menus.blade.php ENDPATH**/ ?>