...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('Name'),__('Color'),__('Order'),__('URL'),__('Active?'),'action','action'])]); ?>
                    <?php $__empty_1 = true; $__currentLoopData = $_menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <div class="flex items-center justify-start <?php echo e($menu->is_active ? 'text-green-400' : 'text-gray-300'); ?>">
...
$__html = app('livewire')->mount($__name, $__params, 'a0MKkcZ', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'PmWyXYU', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'Zcm2uqK', $__slots ?? [], get_defined_vars());
