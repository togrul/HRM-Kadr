<div class="flex flex-col space-y-2">
    ...
    <?php $__currentLoopData = $this->staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
          <?php $__errorArgs = ["staff.$key.position_id"];
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
            <?php $__errorArgs = ["staff.$key.total"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
            <?php $__errorArgs = ["staff.$key.filled"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
            ...
            <?php $__errorArgs = ["staff.$key.vacant"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/staff-schedule/edit-staff.blade.php ENDPATH**/ ?>