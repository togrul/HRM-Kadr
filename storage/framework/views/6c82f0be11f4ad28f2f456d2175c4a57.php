...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-16 h-16 fill-current text-gray-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-16 h-16 fill-current text-gray-500']); ?>
...
<?php endif; ?>
                ...
                <h1 class="text-black font-title font-bold text-2xl text-center">
                    <?php echo e(__('Human Resources Management system')); ?></h1>
                <div class="">
                    <!-- Session Status -->
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <label for="remember_me" class="inline-flex items-center">
                                <input id="remember_me" type="checkbox"
                                    ...
                                    name="remember">
                                <span
                                    class="ml-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Remember me')); ?></span>
                            </label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'flex transition w-full py-4 duration-300 justify-center items-center font-medium text-base','mode' => 'gray']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex transition w-full py-4 duration-300 justify-center items-center font-medium text-base','mode' => 'gray']); ?>
...
<?php endif; ?>
        ...
        <div class="w-full bg-white/40 py-3 px-3 h-full">
            <div
                ...
                <img src="<?php echo e(asset('assets/images/login2.png')); ?>" alt="" class="object-contain max-w-lg">
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/auth/login.blade.php ENDPATH**/ ?>