     ...
     x-init="
        ...
        Livewire.hook('message.processed', (message,component) => {
            ...
            if(
                ...
                || ['workNormUpdated'].includes(message.updateQueue[0].payload.event)
...
<?php endif; ?>
                <span><?php echo e(__('Add work norm')); ?></span>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('ID'),__('Name'),'action'])]); ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $workNorms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $norm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col space-y-1">
                                        <span class="text-sm font-medium">
                                            <b>AZ</b> - <?php echo e($norm->name_az); ?>

                                        </span>
                                        <span class="text-sm font-medium">
                                            <b>EN</b> - <?php echo e($norm->name_en); ?>

                                        </span>
                                        <span class="text-sm font-medium">
                                            <b>RU</b> - <?php echo e($norm->name_ru); ?>
...
<?php $component->withAttributes(['isButton' => true,'width' => '100']); ?>
                                    <div class="flex items-center space-x-2">
                                        <button
                                            wire:click.prevent="openCrud(<?php echo e($norm->id); ?>)"
...
<?php endif; ?>
                                        ...
                                        <button
                                            wire:click.prevent = "deleteModel(<?php echo e($norm->id); ?>)"
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/admin/work-norms.blade.php ENDPATH**/ ?>