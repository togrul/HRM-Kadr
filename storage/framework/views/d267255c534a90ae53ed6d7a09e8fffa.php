...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <!--[if BLOCK]><![endif]--><?php if(array_key_exists('content',$template_data)): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e(\Illuminate\Support\Facades\Storage::url($template_data['content'])); ?>" target="_blank" class="text-blue-500 flex space-x-2 items-center">
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/includes/template-action.blade.php ENDPATH**/ ?>