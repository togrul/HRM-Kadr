...
<?php endif; ?>
<?php $component->withAttributes(['livewire-event-to-open-modal' => 'deletePersonnelWasSet','event-to-close-modal' => 'personnelWasDeleted','modal-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Delete personnel')),'modal-description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Are you sure you want to delete this personnel?')),'modal-confirm-button-text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Delete')),'wire-click' => 'deletePersonnel']); ?>
...
<?php endif; ?><?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/personnel/delete-personnel.blade.php ENDPATH**/ ?>