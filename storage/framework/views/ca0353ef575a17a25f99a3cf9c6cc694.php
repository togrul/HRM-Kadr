...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-card','data' => ['title' => 'Education']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Education']); ?>
...
<?php if (isset($component)) { $__componentOriginal8e3939701bc9c667d1f9e91d04821cb7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8e3939701bc9c667d1f9e91d04821cb7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-card','data' => ['title' => 'Extra Education','checkbox' => 'hasExtraEducation','checkboxTitle' => 'Has extra education?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('form-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Extra Education','checkbox' => 'hasExtraEducation','checkboxTitle' => 'Has extra education?']); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $extra_education_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $eeModel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex flex-col space-y-2 bg-slate-100 shadow-sm rounded-lg px-4 py-2 relative overflow-hidden">
                    ...
                    <div class="flex items-center space-x-2 border-b w-max border-slate-400 border-dashed">
                        ...
                        <span>-</span>
                        <span class="font-medium text-slate-500"><?php echo e($eeModel['education_type_id']['name']); ?></span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 w-full">
                        <div class="flex flex-col space-y-2">
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Form')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['education_form_id']['name']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Language')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['education_language']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Category')); ?></span>
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                'text-sm font-medium',
                                                'text-emerald-500' => !$eeModel['is_military'],
                                                'text-rose-500' => $eeModel['is_military']
                                ]); ?>"><?php echo e($eeModel['is_military'] ? __('Military') : __('Property')); ?></span>
                            </div>
                        </div>

                        <div class="flex flex-col space-y-2">
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Program')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['education_program_name']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Document')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['education_document_type_id']['name']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Serial number')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['diplom_serie']); ?><?php echo e($eeModel['diplom_no']); ?></span>
                            </div>
                        </div>

                        <div class="flex flex-col space-y-2">
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Diplom given date')); ?></span>
                            ...
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Admission year')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['admission_year']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Graduated year')); ?></span>
                                <span class="text-sm font-medium text-slate-800"><?php echo e($eeModel['graduated_year']); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="flex flex-col space-y-1 border-b border-gray-300">
                                ...
                                <span class="text-sm font-medium text-blue-500"><?php echo e($eeModel['coefficient']); ?></span>
                            </div>
                            <div class="flex flex-col space-y-1">
                                <span class="font-medium text-slate-500 text-sm"><?php echo e(__('Extra seniority')); ?></span>
