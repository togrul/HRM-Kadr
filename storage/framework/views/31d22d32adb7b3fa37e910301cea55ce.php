     ...
     x-init="
        ...
        Livewire.hook('message.processed', (message,component) => {
            ...
            if(
                ...
                || ['languageUpdated'].includes(message.updateQueue[0].payload.event)
...
<?php endif; ?>
                <span><?php echo e(__('Add language')); ?></span>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('ID'),__('Name'),'action'])]); ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php $component->withAttributes(['isButton' => true,'width' => '100']); ?>
                                    <div class="flex items-center space-x-2">
                                        <button
                                            wire:click.prevent="openCrud(<?php echo e($lang->id); ?>)"
...
<?php endif; ?>
                                        ...
                                        <button
                                            wire:click.prevent = "deleteModel(<?php echo e($lang->id); ?>)"
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/admin/languages.blade.php ENDPATH**/ ?>