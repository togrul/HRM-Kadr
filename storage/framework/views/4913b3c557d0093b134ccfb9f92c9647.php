...
<!--[if BLOCK]><![endif]--><?php if($type == 'button'): ?>
    <button <?php if($disabled): echo 'disabled'; endif; ?>
        <?php echo e($attributes->merge(['type' => 'submit', 'class' => 'camelcase inline-flex justify-center items-center px-3 py-2 border rounded-md font-medium shadow-md text-sm focus:outline-none focus:ring ring-gray-300 disabled:opacity-25 transition-all ease-in-out duration-150 ' . $extraClasses])); ?>>
        <?php echo e($slot); ?>

    </button>
<?php else: ?>
    <a
        <?php echo e($attributes->merge(['type' => 'submit', 'class' => 'camelcase inline-flex justify-center items-center px-3 py-2 border border-transparent rounded-md font-medium shadow-md text-sm focus:outline-none focus:ring ring-gray-300 disabled:opacity-25 transition-all ease-in-out duration-150 ' . $extraClasses])); ?>>
        <?php echo e($slot); ?>

    </a>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/components/button.blade.php ENDPATH**/ ?>