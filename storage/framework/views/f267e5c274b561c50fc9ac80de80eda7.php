...
<?php endif; ?>
                <span><?php echo e(__('Add status')); ?></span>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([__('ID'),__('Name'),'action'])]); ?>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $_appeal_statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appealStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
...
<?php $component->withAttributes(['isButton' => true,'width' => '100']); ?>
                                    <div class="flex items-center space-x-2">
                                        <button
                                            wire:click.prevent="openCrud(<?php echo e($appealStatus->id); ?>)"
...
<?php endif; ?>
                                        ...
                                        <button
                                            wire:click.prevent = "deleteModel(<?php echo e($appealStatus->id); ?>)"
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/admin/appeal-status.blade.php ENDPATH**/ ?>