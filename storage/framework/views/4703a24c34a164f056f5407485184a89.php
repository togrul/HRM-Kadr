...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'role_name','value' => __('Role')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'role_name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Role'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.livewire-input','data' => ['id' => 'role_name','name' => 'role_name','mode' => 'gray','class' => 'block mt-1 w-full sm:text-sm outline-none font-medium h-10 dark:bg-gray-700 '.e($errors->any() ? 'border-red-600' : '').'','type' => 'text','value' => old('role_name'),'wire:model' => 'role_name','required' => true,'autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'role_name','name' => 'role_name','mode' => 'gray','class' => 'block mt-1 w-full sm:text-sm outline-none font-medium h-10 dark:bg-gray-700 '.e($errors->any() ? 'border-red-600' : '').'','type' => 'text','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('role_name')),'wire:model' => 'role_name','required' => true,'autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['mode' => 'primary','class' => 'space-x-2']); ?>
                            <?php if (isset($component)) { $__componentOriginal5c55aea750bbf450cfe376b1fb8549aa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5c55aea750bbf450cfe376b1fb8549aa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.key-icon','data' => ['color' => 'text-white','hover' => 'text-gray-50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('icons.key-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal5c55aea750bbf450cfe376b1fb8549aa)): ?>
<?php $attributes = $__attributesOriginal5c55aea750bbf450cfe376b1fb8549aa; ?>
<?php unset($__attributesOriginal5c55aea750bbf450cfe376b1fb8549aa); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5c55aea750bbf450cfe376b1fb8549aa)): ?>
<?php $component = $__componentOriginal5c55aea750bbf450cfe376b1fb8549aa; ?>
<?php unset($__componentOriginal5c55aea750bbf450cfe376b1fb8549aa); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.tbl','data' => ['headers' => [__('Name'), 'action', 'action', 'action']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'role_name','name' => 'role_name','mode' => 'gray','class' => 'flex w-auto sm:text-sm outline-none font-normal h-auto dark:bg-gray-700 dark:border-black dark:text-white '.e($errors->any() ? 'border-red-600' : '').'','type' => 'text','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('role_name')),'wire:model' => 'role_name','autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9364c0b92ee5ab519273634c79f86a27)): ?>
<?php $attributes = $__attributesOriginal9364c0b92ee5ab519273634c79f86a27; ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['class' => 'max-w-[50px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php $component->withAttributes(['class' => 'max-w-[50px]']); ?>
                                <button
                                    ...
                                    wire:click="editRole(<?php echo e($role->id); ?>)">
...
<?php $component->withAttributes(['class' => 'max-w-[50px]']); ?>
                                ...
                                <button wire:click.prevent="openSideMenu('set-permission',<?php echo e($role->id); ?>)"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.shield-icon','data' => ['color' => 'text-teal-500','hover' => 'text-teal-600','size' => 'w-7 h-7']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'text-teal-500','hover' => 'text-teal-600','size' => 'w-7 h-7']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginalc91c98e046a1434e6f8cdd0cdedd160b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc91c98e046a1434e6f8cdd0cdedd160b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.td','data' => ['isButton' => true,'class' => 'max-w-[50px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('table.td'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['isButton' => true,'class' => 'max-w-[50px]']); ?>
                                
                                <button wire:click.prevent="setDeleteRole(<?php echo e($role->id); ?>)"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2058529640-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2058529640-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/roles/manage-roles.blade.php ENDPATH**/ ?>