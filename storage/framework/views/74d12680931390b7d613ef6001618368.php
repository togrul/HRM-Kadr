...
$__html = app('livewire')->mount($__name, $__params, '4d4mW5G', $__slots ?? [], get_defined_vars());
...
<div class="px-2 py-2 sm:col-span-2 md:col-span-3">
    ...
    <?php if($selectedService == 'general'): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lxabzIA', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'R68C8Qd', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'iRZS5vk', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'plKo9OG', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'vL1OWAC', $__slots ?? [], get_defined_vars());
...
</div><?php /**PATH /Users/togruljalalli/Desktop/projects/HR-CRM/resources/views/livewire/services/service.blade.php ENDPATH**/ ?>