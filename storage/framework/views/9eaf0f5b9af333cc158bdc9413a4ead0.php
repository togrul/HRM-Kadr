...
<?php endif; ?>
                <select name="selectedYear" id="selectedYear" wire:model.live="selectedYear" <?php if(!empty($filter['date']['min'] ?? null) || !empty($filter['date']['max'] ?? null)): echo 'disabled'; endif; ?>
...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="text-teal-500"><?php echo e($_vacation->duration); ?>

                                                <?php echo e(__('day')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="text-gray-500"><?php echo e(__('Start date')); ?>:</span>
                                            <span
                                                class="text-sky-500"><?php echo e(\Carbon\Carbon::parse($_vacation->start_date)->format('d.m.Y')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="text-gray-500"><?php echo e(__('End date')); ?>:</span>
                                            <span
                                                class="text-rose-500"><?php echo e(\Carbon\Carbon::parse($_vacation->end_date)->format('d.m.Y')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <span class="text-gray-500"><?php echo e(__('Return work date')); ?>:</span>
                                            <span
                                                class="text-green-500"><?php echo e(\Carbon\Carbon::parse($_vacation->return_work_date)->format('d.m.Y')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            ...
                                            ?>
                                            <span
                                                class="text-sm text-gray-500 flex-shrink-0"><?php echo e(__('Vacation days')); ?>:
                                            </span>
                                            <div
                                                class="rounded-lg h-2 bg-slate-200 relative w-20 overflow-hidden flex justify-center items-center">
                                                <div class="absolute left-0 h-full bg-<?php echo e($color); ?>-500 shadow-sm"
                                                    style="width: <?php echo e($percentage); ?>%"></div>
                                            </div>
                                            <span
                                                class="text-sm z-10 text-slate-900 font-medium"><?php echo e($_vacation->remaining_days); ?>/<?php echo e($_vacation->vacation_days_total); ?></span>
                                        </div>
                                    </div>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                    <div class="flex flex-col text-sm font-medium">
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <a href="<?php echo e(route('orders', ['search' => ['order_no' => $_vacation->order_no]])); ?>"
                                                class="text-blue-600"><?php echo e($_vacation->order_no); ?></a>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span
                                                class="text-black"><?php echo e(\Carbon\Carbon::parse($_vacation->order_date)->format('d.m.Y')); ?></span>
                                        </div>
                                    </div>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['isButton' => true]); ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export-vacations')): ?>
                                        <button wire:click="printVacationDocument('<?php echo e($_vacation->id); ?>')"
...
<?php /**PATH /Users/togruljalalli/Desktop/projects/HRM/resources/views/livewire/vacation/vacations.blade.php ENDPATH**/ ?>