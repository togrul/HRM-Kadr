...
return [
    'items' => [
        ...
        'export-compensation' => 'Kompensasiya məlumatlarını ixrac etmək icazəsi verir.',
        'view-compensation-amounts' => 'Maaş məbləğlərini maskasız (açıq) görmək icazəsi verir — həssas məlumat.',
        'show-payroll' => 'Əmək haqqı (payroll) modulunu görmək, dövrləri, run-ları və payslip-ləri izləmək icazəsi verir.',
        'manage-payroll' => 'Əmək haqqı dövrləri və run-ları yaratmaq və hesablamaq icazəsi verir.',
        'approve-payroll' => 'Hesablanmış əmək haqqı run-larını təsdiqləmək icazəsi verir.',
        'lock-payroll' => 'Əmək haqqı run-larını kilidləmək və yenidən açmaq icazəsi verir.',
        'export-payroll' => 'Əmək haqqı məlumatlarını ixrac etmək icazəsi verir.',
    ...
    'fallback' => 'Bu icazə müvafiq ekran və funksiyalara giriş vermək üçün istifadə olunur.',
];
